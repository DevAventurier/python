...
for i in range(3): # la boucle ci oblige lutilisateur a entrer un nombre dentiers predefinis
    ...
    while num == 0: # pour specifier une action pour  que si zero est saisi le programme le rejete
        print("Zero est à la fois pair et impair")
        num = int(input("Veuillez donc entrer un entier différent de zéro: "))
